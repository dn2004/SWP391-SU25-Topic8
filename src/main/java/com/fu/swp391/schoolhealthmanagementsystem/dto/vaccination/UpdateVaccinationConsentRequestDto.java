...
public record UpdateVaccinationConsentRequestDto(
    @Schema(description = "Trạng thái phiếu đồng ý (APPROVED/DECLINED)", example = "APPROVED")
    @NotNull(message = "Trạng thái không được để trống")
    ConsentStatus status,

    @Schema(description = "Phản hồi của phụ huynh", example = "Con tôi không có tiền sử dị ứng thuốc")
