...
public record DashboardAdminDto(
    ...
    @Schema(description = "Tổng số quản lý nhân viên")
    ...
    @Schema(description = "Số học sinh theo giới tính")
    ...
    @Schema(description = "Số sự cố gần đây")
    long recentIncidents,
    @Schema(description = "Số sự cố nghiêm trọng")
    ...
    @Schema(description = "Số chiến dịch theo trạng thái")
    ...
    @Schema(description = "Tổng số giao dịch thuốc")
    long totalMedicationTransactions,
    @Schema(description = "Số giao dịch thuốc theo loại")
