...
public record UpdateHealthIncidentRequestDto(
        ...
        @Size(min = 10, max = 2000, message = "Mô tả sự cố phải từ 10 đến 2000 ký tự")
        String description,
        ...
        @Size(min = 10, max = 2000, message = "Hành động xử lý phải từ 10 đến 2000 ký tự")
        String actionTaken,

        @Schema(description = "Địa điểm xảy ra sự cố", example = "Sân thể dục")
        @Size(max = 100, message = "Địa điểm không quá 100 ký tự")
        String location
) {}