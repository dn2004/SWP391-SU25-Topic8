...
public record HealthIncidentResponseDto(
        @Schema(
                description = "ID của sự cố sức khỏe",
                example = "1"
        )
        Long incidentId,
        ...
        @Schema(
                description = "ID của người ghi nhận",
                example = "2"
        )
        Long recordedByUserId,

        @Schema(
                description = "Tên của người ghi nhận",
        ...
        @Schema(
                description = "Thời gian tạo sự cố",
                example = "2025-06-13T10:20:00"
        )
        LocalDateTime createdAt,

        @Schema(
                description = "Thời gian cập nhật cuối cùng",
                example = "2025-06-13T11:00:00"
        )
        LocalDateTime updatedAt,

        @Schema(
                description = "ID của người cập nhật cuối cùng",
                example = "202"
        )
        Long updatedByUserId,

        @Schema(
                description = "Tên của người cập nhật cuối cùng",
                example = "Dr. Le Van C"
        )
